...
const adicionarParticipante = (event) => {
  ...
  //verificar se o particiapnte ja existe
...
const fazerCheckIn = (event) => {
  // confirmar se realmente que fazer o checkin
  ...
  const particapnte = participantes.find((p) => {
    return p.email == event.target.dataset.email
  })
  // atualizar o checkIN do participante
  particapnte.dataCheckIn = new Date()
  // atualizar a lsita de particapnte
  atualizarLista(participantes)
